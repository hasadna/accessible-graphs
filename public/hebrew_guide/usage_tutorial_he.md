# מדריך למערכת Sensory Interface
...
## שלב 2
 * בכדי להנגיש את הנתונים, היכנסו לקישור [Builder - Sensory interface](https://sensoryinterface.com/builder/index.html)

 * פוקוס המקלדת ינחת בתיבת עריכה בה ניתן להדביק את הנתונים שהועתקו מגיליון האקסל.
 * הדביקו את הנתונים שהעתקתם מגיליון האקסל על ידי צירוף המקשים Ctrl + V
 * לחצו על מקש ה TAB עד שתגיעו לכפתור View ולחצו על ENTER.
